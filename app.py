...
with col1:
    ...
    prob_cliente_normal_recrutar = st.number_input(
        "Prob. Cliente Comum Recrutar Alguém (valores entre 0 e 1, 0.5 significa 50%)",
        value=0.03,
        step=0.01,
	min_value = 0.00,
	max_value = 0.30
    ...
    prob_bom_recrutador = st.number_input(
        "Prob. Bom Recrutador (valores entre 0 e 1, 0.5 significa 50%)",
        value=0.20,
        step=0.01,
	min_value = 0.00,
	max_value = 0.50
    ...
    prob_bom_recrutador_filho = st.number_input(
        "Prob. Filho de Bom Recrutador também ser (valores entre 0 e 1, 0.5 significa 50%)",
        value=0.30,
        step=0.01,
	min_value = 0.00,
	max_value = 1.00
