...
def simulacao_completa(prob_cliente_normal_recrutar = 0.03,
    ...
    df_mensal['pct_rede_recrutamento'] = (df_mensal['bonus_por_rede_total'] + df_mensal['comissao_recrutamento']) / (df_mensal['Receita_cliente'] + df_mensal['Receita'])

    df_mensal['total_bonus'] = df_mensal['bonus_por_rede_total'] + df_mensal['comissao_recrutamento']
    df_mensal = df_mensal[['Mes', 'Consultores', 'Receita', 'Receita_cliente', 'total_bonus', 'pct_rede_recrutamento']]
